...
export const ITEM_RESOURCES: Record<string, ChecklistResource[]> = {
  ...
  "doc-cd-brief": [ARBV_WORK],
  "doc-cd-conditions": [PE_ACT, ARBV_WORK],
  "doc-cd-nonconforming": [BUILDING_ACT, PE_ACT, NCC2025],
  "doc-cd-closeout": [ARBV_WORK],
  "dw-cd-north": [ARBV_WORK],
  "dw-cd-scale": [ARBV_WORK],
  "dw-cd-stamp": [ARBV_WORK],
  "dw-cd-legend": [ARBV_WORK],
  "dw-cd-demo-retain": [ARBV_WORK],
  "dw-cd-demo-trees": [PE_ACT, CL55],
  "dw-cd-demo-survey": [LANDATA, ARBV_WORK],
  "dw-cd-demo-protect": [BUILDING_ACT, BUILDING_REGS],
  "dw-cd-site-title": [LANDATA, BUILDING_REGS],
  "dw-cd-site-civil": [NCC_LIVABLE, NCC2025],
  "dw-cd-site-services": [NCC2025, BUILDING_ACT],
  "dw-cd-site-context": [CL5206, CL55],
  "dw-cd-ga-coord": [ARBV_WORK],
  "dw-cd-ga-fire": [NCC2025, BUILDING_ACT],
  "dw-cd-ga-wet": [NCC_WATERPROOF, STANDARDS],
  "dw-cd-ga-access": [NCC2025, NCC_LIVABLE],
  "dw-cd-ga-types": [BADS, CL58],
  "dw-cd-rcp-heights": [NCC2025, ARBV_WORK],
  "dw-cd-rcp-services": [NCC2025, ARBV_WORK],
  "dw-cd-rcp-detection": [NCC2025, BUILDING_REGS],
  "dw-cd-rcp-structure": [NCC2025, ARBV_WORK],
  "dw-cd-elev-heights": [PE_ACT, BUILDING_ACT],
  "dw-cd-elev-junctions": [NCC_WATERPROOF, NCC2025],
  "dw-cd-elev-openings": [STANDARDS, ARBV_WORK],
  "dw-cd-elev-stairs": [NCC2025, NCC_LIVABLE],
  "dw-cd-roof-drain": [NCC2025, NCC_WATERPROOF],
  "dw-cd-roof-plant": [NCC2025, ARBV_WORK],
  "dw-cd-roof-penet": [NCC2025, NCC_CONDENSATION],
  "dw-cd-roof-access": [NCC2025, ARBV_WORK],
  "doc-cd-doors": [STANDARDS, NCC2025],
  "doc-cd-hardware": [STANDARDS, NCC2025],
  "doc-cd-sills": [NCC2025, ARBV_WORK],
  "doc-cd-materials": [ARBV_WORK],
  "tn-set": [DBC, CONSUMER],
  ...
  "dw-pd-titleblock": [ARBV_WORK],
  "dw-pd-boundaries": [LANDATA],
  "dw-pd-overlays": [VICPLAN, VPP],
  "dw-pd-existing": [ARBV_WORK],
  "dw-sk-titleblock": [ARBV_WORK],
  "dw-sk-plans": [CL54, CL55, CL58],
  "dw-sk-solar": [NATHERS, NCC_ENERGY],
  "dw-sk-option": [ARBV_WORK],
  "dw-dd-index": [ARBV_WORK],
  "dw-dd-coord": [ARBV_WORK],
  "dw-dd-esd": [NCC2025, BADS],
  "dw-dd-consult": [ARBV_WORK],
  "dw-tp-title": [PE_ACT],
  "dw-tp-assessment": [CL54, CL55, CL58],
  "dw-tp-summary": [CL54, CL55, CL58],
  "dw-tp-neighbour": [CL54, CL55],
  "dw-cd-index": [BUILDING_ACT, BUILDING_REGS],
  "dw-cd-coord": [ARBV_WORK],
  "dw-cd-ncc": [NCC2025, BPC_NCC],
  "dw-cd-endorsed": [PE_ACT],
  "doc-spec-rev": [ARBV_WORK],
  "doc-spec-ncc": [NCC2025, STANDARDS],
  "doc-spec-finishes": [NCC_WATERPROOF, BUILDING_REGS],
  "doc-spec-prelim": [DBC],
  "doc-tn-list": [ARBV_WORK],
  "doc-tn-addenda": [ARBV_WORK],
  "doc-tn-form": [DBC],
  "doc-tn-sums": [DBC],
  "dw-ca-ifc": [BUILDING_ACT],
  "dw-ca-permit": [BUILDING_ACT, BUILDING_REGS],
  "dw-ca-rfi": [ARBV_WORK],
  "dw-ca-issue": [BUILDING_ACT],
  "doc-pc-inspect": [DBC],
  "doc-pc-defects": [DBC],
  "doc-pc-handover": [BUILDING_ACT, BUILDING_REGS],
  "doc-pc-cert": [DBC],
  "doc-dlp-dates": [DBC],
  "doc-dlp-open": [ARBV_WORK],
  "doc-dlp-bond": [BOND],
  "doc-dlp-notices": [DBC],
  "doc-fc-inspect": [DBC],
  "doc-fc-warr": [DBC, BUILDING_ACT],
  "doc-fc-security": [DBC, SOP],
  "doc-fc-archive": [ARBV_WORK, ARCHITECTS_ACT],
  "doc-poe-dates": [ARBV],
  "doc-poe-comfort": [NCC_ENERGY, NATHERS],
  "doc-poe-landscape": [CL55, CL58],
  "doc-poe-lessons": [ARBV_WORK],
};
