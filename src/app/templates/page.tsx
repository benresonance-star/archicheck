      ...
      <main className="mx-auto max-w-3xl space-y-6 px-4 py-6">
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            need notes, attachments and a ZIP. Each deliverable is a list of
            one-line checks. Tap a row for what must be established, why,
            evidence and the assessment. <strong>Audit</strong> keeps sources
