      ...
      <main className="mx-auto max-w-3xl space-y-6 px-4 py-6">
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            need notes, attachments and a ZIP. Each deliverable stays a dense
            list. Tick on the row; tap the title to inspect the requirement in
            a sheet. <strong>Audit</strong> stays in that sheet.
          </p>
        </section>
