...
Each deliverable is a compact **browse** list (title + tick). Tapping a title opens a **requirement** sheet for understanding and **Audit** — the list does not expand in place. Lists in parentheses (overlays, accessibility notes, development-summary figures) sit as indented sub-dots under their parent. Signals such as Evidence missing sit on the row only when they are not To do. Ticks stay on the device; they are not a project ZIP.
